...
import { UmbPropertyEditorUiRteBaseElement } from '@umbraco-cms/backoffice/rte';
...
export class UmbPropertyEditorUiTiptapElement extends UmbPropertyEditorUiRteBaseElement {
