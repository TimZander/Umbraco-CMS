...
import { UmbPropertyEditorUiRteBaseElement, UMB_BLOCK_RTE_DATA_CONTENT_KEY } from '@umbraco-cms/backoffice/rte';
...
export class UmbPropertyEditorUITinyMceElement extends UmbPropertyEditorUiRteBaseElement {
